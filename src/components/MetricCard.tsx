...
const toneClasses: Record<string, string> = {
  pink: "from-pink-400/20 to-fuchsia-500/10 text-pink-200 shadow-pink-500/10",
...
export function MetricCard({ label, value, delta, tone, icon: Icon }: MetricCardProps) {
  return (
    <article className="glass-panel scanline group rounded-2xl p-5 transition duration-300 hover:-translate-y-1 hover:border-pink-300/30 hover:shadow-glow">
